...
The tool surface is the hand-curated v0.10 catalog —
nine resource × action tools (` + "`pad_item`, `pad_workspace`, `pad_collection`, `pad_project`, `pad_role`, `pad_search`, `pad_meta`, `pad_playbook`, `pad_library`" + `) plus ` + "`pad_set_workspace`" + ` for session-default workspace
