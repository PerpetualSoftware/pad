...
- **The replacement is attempted, not guaranteed.** If the path is still
  ...
  nothing, and only the detector's next pass (phase 2) ever cycled it. Pad now
