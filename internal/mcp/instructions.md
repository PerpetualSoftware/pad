...
When you see it: read the raw value (`pad_item` `action: get`), tell the user which item is affected, and stop. Do not route around it by writing the field some other way; that is the write that caused it.
