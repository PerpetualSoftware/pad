...
- **Looks like a ref** (matches ` + "`^[A-Z][A-Z0-9]*-\\d+$`" + `) → resolve it (` + "`pad item show <target> --format json`" + `) and check its collection before deciding anything else:
