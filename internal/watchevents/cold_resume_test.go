...
func TestACursorFromAPreviousIncarnationIsAGapEvenWithAWarmBuffer(t *testing.T) {
	...
	ch2, missed2, _, _ := b.SubscribeAndReplaySince(context.Background(), b.base+1)
...
func TestSubscribeAndReplaySinceRefusesAColdResume(t *testing.T) {
	...
	ch, missed, _, _ := b.SubscribeAndReplaySince(context.Background(), b.base+4200)
	if ch == nil {
	...
	ch2, missed2, _, _ := b.SubscribeAndReplaySince(context.Background(), 0)
	defer b.Unsubscribe(ch2)
	if ch2 == nil {
