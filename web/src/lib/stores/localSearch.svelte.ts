...
// — a letter followed by letters or digits, BUG-2943), accepting either case
// because a user types a ref however they like and the server upper-cases
// before splitting. `[A-Za-z]+` could not recognise a
